...
def visualize_inference(model_path, data_dir, num_samples=5, output_dir='results/predictions', device='cuda'):
    # [DEVICE]
...
if __name__ == "__main__":
    ...
    visualize_inference(args.model_path, args.data_dir, args.num_samples, args.output_dir)
